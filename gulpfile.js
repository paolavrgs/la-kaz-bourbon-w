...
gulp.task("add_jquery", function () {
  return gulp
    .src("node_modules/jquery/docs/jquery.min.js")
...
gulp.task("add_bootstrap", function () {
  var bootstrap_js = gulp
    .src("node_modules/bootstrap/docs/js/bootstrap.js")
    .pipe(gulp.dest("app/js"));

  var bootstrap_css = gulp
    .src("node_modules/bootstrap/docs/css/bootstrap.min.css")
...
gulp.task("add_materialize", function () {
  var material_js = gulp
    .src("node_modules/materialize-css/docs/js/materialize.min.js")
    .pipe(gulp.dest("app/js"));

  var material_css = gulp
...
gulp.task("fonts", function () {
  return gulp.src("app/fonts/**/*").pipe(gulp.dest("docs/assets/fonts"));
});
//Move new .css files
...
gulp.task(
  "default",
  ["browserSync", "compile_haml", "compile_sass", "css", "js"],
  function () {
